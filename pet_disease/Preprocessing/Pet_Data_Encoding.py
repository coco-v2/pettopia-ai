...
class Pet_Data_Encoding():
    ...
    def __init__(self):
        ...
        self.dog_breed_dictionary = {'GRE' : '1', 'DAL':'2', 'DAS':'3', 'DOB':'4','GOL':'5',
                        ...
                        'MIS':'27', 'ETC':'28'}
        self.cat_breed_dictionary = {'KOR':'1', 'RUS':'2', 'PER':'3', 'SIA':'4', 'TUR':'5',
                          'SCO':'6', 'MIX':'7', 'ETC':'8'}
        self.pet_class_dictionary = {'LH':'1', 'SH':'2', 'UK':'3'}
        self.sex_dictionary = {'IM':'1', 'IF':'2', 'CM':'3', 'SF':'4'}
    ...
    def dog_data_encoding(self):
        ...
        for line in data:
            ...
            line[2] = self.dog_breed_dictionary.get(breed)
            line[4] = self.pet_class_dictionary.get(pet_class)
            line[5] = self.sex_dictionary.get(sex)
    ...
    def cat_data_encoding(self):
        ...
        for line in data:
            ...
            line[2] = self.cat_breed_dictionary.get(breed)
            line[4] = self.pet_class_dictionary.get(pet_class)
            line[5] = self.sex_dictionary.get(sex)
